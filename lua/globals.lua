...
if utils.executable('python3') then
  if vim.g.is_win then
    ...
    -- this virtualenv should have pynvim, pylsp, pylint installed
    vim.g.python3_host_prog = py3nvim.python3_host_prog
  end
else
...
vim.g.mapleader = ','
-- Map <LocalLeader> to be same as <Leader>
